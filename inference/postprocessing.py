...
def load_remove_save(input_file: str, output_file: str, for_which_classes: list,
    ...
    img_out_itk.SetOrigin(img_in.GetOrigin())
    img_out_itk.SetDirection(img_in.GetDirection())
    img_out_itk.SetSpacing(img_in.GetSpacing())
...
def determine_postprocessing(base, gt_labels_folder, raw_subfolder_name="validation_prediction",
                             temp_folder="temp", final_subf_name="validation_final", num_processesor=8,
                             dice_threshold=0, debug=False, advanced_postprocessing=False,
    ...
    _ = aggregate_scores(pred_gt_tuples, labels=classes,
                         ...
                         json_author="Fabian", num_threads=num_processesor)
